...
\begin{frame}
  ...
  \only<1->{%
    \includegraphics[width=.8\textwidth]{img/pic2.png}
    \caption{PICTURE 2.}
  }
...
\begin{frame}
  ...
  \begin{itemize}
    \item В минералогии эффект Мёссбаура применяется главным образом для определения структурного положения ионов Fe и определения степени окисления железа.
\end{frame}
